...
```{r}
mean_calls <- 15 #I like that you set this up first,I just put 15 each time
```
...
*This looks great! The only note I have is you could definitely make more notes and annotate your coding more!*
